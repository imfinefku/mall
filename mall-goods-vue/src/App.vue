    ...
    <el-container>
      ...
      <div class="topbar">
        <div class="nav">
          <ul>
            ...
            <li>
              <el-button type="text" @click="dzpdLogin" >个人中心</el-button>
      ...
      <el-header>
        ...
        >
          ...
          <el-menu-item index="/goods">商城直营</el-menu-item>
          <!-- <el-menu-item index="/idle">二手闲置</el-menu-item> -->
<!--          <el-menu-item index="/buying">求购信息</el-menu-item>-->
...
export default {
  ...
  data() {
    return {
      ...
      allSun: window.localStorage.getItem("trolleyAmount")
    };
  },
  created() {
  ...
  watch: {
    ...
    getUser: function (val) {
      if (val === "") {
        ...
        // 用户已经登录,获取该用户的购物车信息
        this.$axios
            .get("/mallGoods/selectCollectionList/" + 2)
            .then(res => {
              console.log(res)
              if (res.data.code === 20000) {
                // 001 为成功, 更新vuex购物车状态
                this.setShoppingCart(res.data.data.list);
              } else {
                // 提示失败信息
